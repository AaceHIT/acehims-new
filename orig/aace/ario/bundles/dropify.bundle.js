! function(i, e) {
	...
	function e(i, e) {
		if (window.File && window.FileReader && window.FileList && window.Blob) {
			this.element = i, this.input = h(this.element), this.wrapper = null, this.preview = null, this.filenameWrapper = null, this.settings = h.extend(!0, {
				defaultFile: "",
				maxFileSize: 0,
				minWidth: 0,
				maxWidth: 0,
			...
			}, e, this.input.data()), this.errorsEvent = h.Event("dropify.errors"), this.isDisabled = !1, this.isInit = !1, this.file = {
				object: null,
				name: null,
				size: null,
				width: null,
	...
	return e.prototype.onChange = function() {
		...
		if (i.files && i.files[0]) {
			var e = new FileReader,
				...
				r = null,
				n = this,
				o = h.Event("dropify.fileReady");
			this.clearErrors(), this.showLoader(), this.setFileInformations(s), this.errorsEvent.errors = [], this.checkFileSize(), this.isFileExtensionAllowed(), this.isImage() && this.file.size < this.sizeToByte(this.settings.maxFileSizePreview) ? (this.input.on("dropify.fileReady", this.onFileReady), e.readAsDataURL(s), e.onload = function(i) {
				r = i.target.result, t.src = i.target.result, t.onload = function() {
					n.setFileDimensions(this.width, this.height), n.validateImage(), n.input.trigger(o, [!0, r])
				}
		...
		if (this.input.off("dropify.fileReady", this.onFileReady), 0 === this.errorsEvent.errors.length) this.setPreview(e, t);
			...
			for (var s = this.errorsEvent.errors.length - 1; 0 <= s; s--) {
				var r = this.errorsEvent.errors[s].namespace.split(".").pop();
				this.showError(r)
			}
		...
		if (this.hideLoader(), !0 === i) {
			var s = h("<img />").attr("src", e);
			this.settings.height && s.css("max-height", this.settings.height), s.appendTo(t)
		} else h("<i />").attr("class", "dropify-font-file").appendTo(t), h('<span class="dropify-extension" />').html(this.getFileType()).appendTo(t);
		this.preview.fadeIn()
		...
		if (0 === this.errorsEvent.errors.length) {
			var i = h.Event("dropify.beforeClear");
			this.input.trigger(i, [this]), !1 !== i.result && (this.resetFile(), this.input.val(""), this.resetPreview(), this.input.trigger(h.Event("dropify.afterClear"), [this]))
		...
		var e = 0;
		if (0 !== i) {
			var t = i.slice(-1).toUpperCase(),
				s = 1048576;
			"K" === t ? e = 1024 * parseFloat(i) : "M" === t ? e = parseFloat(i) * s : "G" === t && (e = 1073741824 * parseFloat(i))
		}
		return e
		...
		var e = h.Event("dropify.error." + i);
		this.errorsEvent.errors.push(e), this.input.trigger(e, [this])
		...
		return this.each(function() {
			h.data(this, t) || h.data(this, t, new e(this, i))
		}), this
	}, e
});