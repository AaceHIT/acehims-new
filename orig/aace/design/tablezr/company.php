<div class="table-responsive">
	<table class="table table-hover center-aligned-table align-middle">
		...
		<thead class="table-dark">
			<tr>
				<th colspan="1">S/N</th>
				<th colspan="1" class="col-md-5 text-left">Company</th>
		...
		<tbody>
			...
			foreach ($content as $row) {
				...
				<tr>
					...
					<td><a href="<?php AaceUtil::linkTo('company/detail', ['id' => $row->puid]); ?>" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-file fa-fw"></i> View</a></td>
					<td class="text-center"><a href="<?php AaceUtil::linkTo('company/update', ['id' => $row->puid]); ?>" class="btn btn-outline-info btn-sm"><i class="fa-solid fa-pen-to-square fa-fw"></i> Update</a></td>
					<td class="text-center"><a href="<?php AaceUtil::linkTo('company/delete', ['id' => $row->suid]); ?>" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fa-fw"></i> Delete</a></td>
				</tr>
			<?php } ?>
		</tbody>
