<form name="oForm" id="oForm" method="POST" action="<?php Utilizr::uri(); ?>">
	<div class="card-body">
		<h4 class="ao-section-title small mb-4">Radiology Information</h4>
		<?php
		Utilizr::notifyFailure('The scan was not created');
		Utilizr::notifySuccess('The scan has been created successfully');
		...
		<div class="row g-4 clearfix">
			...
			<div class="col-md-4 col-sm-6">
				<div class="form-floating">
					<input type="text" class="form-control" placeholder="Scan Name" name="title">
