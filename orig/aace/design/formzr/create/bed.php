<form name="oForm" id="oForm" method="POST" action="<?php Utilizr::uri(); ?>">
	<div class="card-body">
		...
		<?php
		Utilizr::notifyFailure('The bed was not created');
		Utilizr::notifySuccess('The bed has been created successfully');
		if (!Utilizr::isLinkStatus('success')) { ?>
			...
			<div class="row g-4 clearfix">
				<div class="col-md-4 col-sm-6">
					<div class="form-floating">
						<select class="form-select" name="oward" required>
							...
							<?php FormQ::select(AaceUtil::formOption('WARD')); ?>
						</select>
						<label>Ward</label>
					</div>
				</div>
				<div class="col-md-2 col-sm-12">
					<div class="form-floating">
						<input type="text" class="form-control" placeholder="Bed Number" name="title" required>
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-floating">
						<input type="text" class="form-control" placeholder="Bed ID" name="code" value="<?php echo RandomQ::alphanumeric(7, 'UPPERCASE'); ?>">
						<label>Bed ID</label>
					</div>
				</div>
