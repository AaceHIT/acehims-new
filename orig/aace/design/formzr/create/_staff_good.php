	...
	<div class="card-body">
		...
		if (!Utilizr::isLinkStatus('success')) { ?>
			...
			<div class="row g-4 clearfix">
				...
				<div class="col-md-3 col-sm-6">
					<div class="form-floating">
						<select class="form-select" name="department" tabindex="16">
							<option value=""> - Select - </option>
				...
				<div class="col-md-2">
					<input type="file" id="photoFile" name="dp" class="dropify" accept="image/*" data-height="218" data-max-file-size="2M" data-allowed-formats="portrait square" data-allowed-file-extensions="jpg jpeg png" onchange="imageUploadWithPreview('photoFile', 'photoPreview', 'cameraPhoto')">
				</div>
