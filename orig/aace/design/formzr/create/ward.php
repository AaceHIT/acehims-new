<form name="oForm" id="oForm" method="POST" action="<?php Utilizr::uri(); ?>">
	<div class="card-body">
		...
		<?php
		Utilizr::notifyFailure('The ward was not created');
		Utilizr::notifySuccess('The ward has been created successfully');
		if (!Utilizr::isLinkStatus('success')) { ?>
			...
			<div class="row g-4 clearfix">
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-floating">
						<input type="text" class="form-control" placeholder="Ward ID" name="code" value="<?php echo RandomQ::alphanumeric(5, 'UPPERCASE'); ?>">
						<label>Ward ID</label>
					</div>
				</div>
