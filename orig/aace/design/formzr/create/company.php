<form name="oForm" id="oForm" method="POST" action="<?php Utilizr::uri(); ?>">
	<div class="card-body">
		...
		<?php
		Utilizr::notifyFailure('The company was not created');
		Utilizr::notifySuccess('The company has been created successfully');
		if (!Utilizr::isLinkStatus('success')) { ?>
			...
			<div class="row g-4 clearfix">
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-floating">
						<input type="text" class="form-control" placeholder="Code" name="code" value="CIN<?php echo RandomQ::digit(8); ?>">
						<label>Code</label>
					</div>
				</div>
			...
			<div class="row g-4 clearfix">
				...
				<div class="col-12">
					<div class="form-floating">
						<textarea placeholder="Add Note" class="form-control" rows="4" name="note"></textarea>
						<label>Note</label>
					</div>
				</div>
			</div>
