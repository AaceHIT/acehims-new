<div class="user-account mx-3 my-4 text-start">
	<div class="d-flex">
		<img src="<?php echo Utilizr::image(AOUtil::sessionUser('dp'), 'DP'); ?>" class="rounded-circle user-photo me-3" alt="Profile Photo">
		<div class="dropdown">
			<span class="d-block">Welcome,</span>
			<a href="#" class="dropdown-toggle user-name" data-bs-toggle="dropdown"><strong><?php echo AOUtil::sessionUser('firstname'); ?></strong></a>
			<ul class="dropdown-menu account">
				...
				<li class="divider"></li>
				<li><a href="<?php AOUtil::linkTo('auth/logout'); ?>"><i class="fa fa-power-off"></i>Logout</a></li>
			</ul>
		</div>
	</div>
