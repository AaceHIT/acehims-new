...
<div class="row clearfix">
	<div class="col-md-12">
		<div class="card mb-4">
			<div class="card-header"><strong>Radiology Information</strong></div>
			<div class="card-body">
				<ul class="nav nav-tabs" id="tabArea" role="tablist">
					<li class="nav-item" role="presentation">
						<a class="nav-link active" id="radiology-tab" data-bs-toggle="tab" href="#radiology" role="tab" aria-controls="radiology" aria-selected="true">About Radiology</a>
					</li>
				</ul>
				<div class="tab-content" id="tabAreaContent">
					<div class="tab-pane fade show active" id="radiology" role="tabpanel" aria-labelledby="radiology-tab">
						<h6 class="text-primary text-uppercase mb-3 mt-2">About Radiology</h6>
						<div class="col-md-4">
