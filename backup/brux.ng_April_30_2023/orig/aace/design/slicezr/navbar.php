<nav class="navbar navbar-fixed-top p-0">
	<div class="container-fluid">
		...
		<div class="navbar-brand">
			<a href="<?php AOUtil::linkTo(AuthModel::static()->userAppLanding()); ?>" class="logo" title="<?php echo Env::property('config')['project']['brand']; ?>"> </a>
		</div>
		<div class="navbar-right">
			...
			<div id="navbar-menu" class="float-end">
				<ul class="navbar-nav flex-row align-items-center">
					...
					?>
					<li class="d-md-inline-block"><a href="<?php AOUtil::linkTo('auth/logout'); ?>" class="icon-menu"><i class="fa fa-sign-out"></i></a></li>
				</ul>
			</div>
		</div>
	</div>
