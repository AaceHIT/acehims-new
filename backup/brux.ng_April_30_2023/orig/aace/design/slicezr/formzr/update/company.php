<form name="oForm" id="oForm" method="POST" action="<?php Utilizr::uri(); ?>">
	<div class="card-body">
		<h4 class="ao-section-title small mb-4">Company Information</h4>
		<?php
		...
		<div class="row g-4 clearfix">
			...
			<div class="col-md-4 col-sm-6">
				<div class="form-floating">
					<input type="text" class="form-control" placeholder="Website" name="website" value="<?php echo Vars::safe($row->website);?>">
					<label>Website</label>
				</div>
			</div>
			...
			<div class="col-12">
				<div class="form-floating">
					<textarea placeholder="Address" class="form-control" rows="4" name="address"><?php echo Vars::safe($row->address);?></textarea>
					<label>Address</label>
				</div>
			</div>
		</div>
		...
		<h4 class="ao-section-title small mb-4">Contact Person</h4>
		<div class="row g-4 clearfix">

			<?php require ORIG['FORM'] . 'chunk' . DS . 'contact-person.php'; ?>
			<div class="col-12">
				<div class="form-floating">
					<textarea placeholder="Add Note" class="form-control" rows="4" name="note"><?php echo Vars::safe($row->note);?></textarea>
					<label>Note</label>
				</div>
			</div>
