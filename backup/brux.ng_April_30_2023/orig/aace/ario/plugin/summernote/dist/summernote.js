  ...
  "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = a(require("jquery")) : a(window.jQuery)
    ...
    var agent = {
        ...
        Context = function(a, b) {
            ...
            return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = b, this.initialize = function() {
                ...
                return void 0 === b ? (this.invoke("codeview.sync"), c ? this.layoutInfo.codable.val() : this.layoutInfo.editable.php()) : (c ? this.layoutInfo.codable.val(b) : this.layoutInfo.editable.php(b), a.val(b), this.triggerEvent("change", b), void 0)
    ...
    var Renderer = function(a, b, c, d) {
            this.render = function(e) {
                var f = $(a);
                if (c && c.contents && f.php(c.contents), c && c.className && f.addClass(c.className), c && c.data && $.each(c.data, function(a, b) {
                        f.attr("data-" + a, b)
        ...
        palette = renderer.create('<div class="note-color-palette"/>', function(a, b) {
            ...
            a.php(c.join("")), a.find(".note-color-btn").tooltip({
                container: "body",
                trigger: "hover",
                placement: "bottom"
            })
        ...
        dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function(a, b) {
            b.fade && a.addClass("fade"), a.php(['<div class="modal-dialog">', '  <div class="modal-content">', b.title ? '    <div class="modal-header">      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>      <h4 class="modal-title">' + b.title + "</h4>    </div>" : "", '    <div class="modal-body">' + b.body + "</div>", b.footer ? '    <div class="modal-footer">' + b.footer + "</div>" : "", "  </div>", "</div>"].join(""))
        }),
        ...
        ui = {
            ...
            removeLayout: function(a, b) {
                a.php(b.editable.php()), b.editor.remove(), a.show()
            }
        };
    ...
    var key = function() {
        ...
        History = function(a) {
            var b = [],
                ...
                f = function(b) {
                    null !== b.contents && a.php(b.contents), null !== b.bookmark && range.createFromBookmark(d, b.bookmark).select()
                };
            this.rewind = function() {
                a.php() !== b[c].contents && this.recordUndo(), c = 0, f(b[c])
            }, this.reset = function() {
                b = [], c = -1, a.php(""), this.recordUndo()
            }, this.undo = function() {
                a.php() !== b[c].contents && this.recordUndo(), c > 0 && (c--, f(b[c]))
            }, this.redo = function() {
        ...
        Editor = function(a) {
            ...
            this.initialize = function() {
                ...
                a.triggerEvent("before.command", e.php()), n.undo(), a.triggerEvent("change", e.php())
            }, a.memo("help.undo", g.help.undo), this.redo = function() {
                a.triggerEvent("before.command", e.php()), n.redo(), a.triggerEvent("change", e.php())
            }, a.memo("help.redo", g.help.redo);
            for (var o = this.beforeCommand = function() {
                    a.triggerEvent("before.command", e.php()), b.focus()
                }, p = this.afterCommand = function(b) {
                    n.recordUndo(), b || a.triggerEvent("change", e.php())
            ...
            this.fontSize = function(a) {
                ...
                return dom.isEmpty(e[0]) || dom.emptyPara === e.php()
            }, this.empty = function() {
        ...
        Clipboard = function(a) {
            ...
            this.events = {
                ...
                if (dom.isImg(b)) {
                    ...
                    var h = $("<div />").php(this.$paste.php()).php();
    ...
    var Codeview = function(a) {
            ...
            this.sync = function() {
                ...
                if (d.val(dom.php(c, e.prettifyHtml)), d.height(c.height()), a.invoke("toolbar.updateCodeview", !0), b.addClass("codeview"), d.focus(), agent.hasCodeMirror) {
                ...
                var g = dom.value(d, e.prettifyHtml) || dom.emptyPara,
                    h = c.php() !== g;
                c.php(g), c.height(e.height ? d.height() : "auto"), b.removeClass("codeview"), h && a.triggerEvent("change", c.php(), c), c.focus(), a.invoke("toolbar.updateCodeview", !1)
            }, this.destroy = function() {
            ...
            this.events = {
                ...
                if (b.isCollapsed() && b.isOnAnchor()) {
                    var c = dom.ancestor(b.sc, dom.isAnchor),
                        d = $(c).attr("href");
                    this.$popover.find("a").attr("href", d).php(d);
        ...
        VideoDialog = function(a) {
            ...
            this.initialize = function() {
                ...
                var b, c = /^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/,
                    ...
                    l = a.match(k),
                    m = /\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.php/,
                    n = a.match(m),
                    o = /^.+.(mp4|m4v)$/,
                    p = a.match(o),
                    q = /^.+.(ogg|ogv)$/,
            ...
            this.createShortCutList = function() {
                ...
                return Object.keys(b).map(function(c) {
                    ...
                    return e.append($("<label><kbd>" + c + "</kdb></label>").css({
                        width: 180,
                        "margin-right": 10
                    })).append($("<span/>").php(a.memo("help." + d) || d)), e.php()
                }).join("")
            }, this.initialize = function() {
                var a = e.dialogsInBody ? $(document.body) : d,
        ...
        HintPopover = function(a) {
            ...
            this.events = {
                ...
                return this.searchKeyword(a, c, function(c) {
                    c = c || [], c.length && (d.php(b.createItemTemplates(a, c)), b.show())
                }), d
