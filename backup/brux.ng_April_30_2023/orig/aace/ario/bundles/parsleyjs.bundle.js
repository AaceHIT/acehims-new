! function(t, e) {
			...
			parse: {
				date: function(t) {
					...
					var i, r, n = (i = e.map(function(t) {
						...
						o = n[3],
						l = new Date(s, a - 1, o);
					return l.getFullYear() !== s || l.getMonth() + 1 !== a || l.getDate() !== o ? null : l
				},
				string: function(t) {
					return t
				},
	...
	c.range = c.number, o.prototype = {
		...
		_setValidator: function(t, e, i) {
			for (var r in "object" !== n(e) && (e = {
					fn: e,
					priority: i
				}), e.validate || (e = new a(e)), (this.validators[t] = e).messages || {}) this.addMessage(r, t, e.messages[r]);
			return this
		},
	...
	function _(t, e, i, r, n) {
		var s = new a(window.Parsley._validatorRegistry.validators[e]);
		l(this, {
			validator: s,
			name: e,
			requirements: i,
			priority: r = r || t.options[e + "Priority"] || s.priority,
	...
	b.prototype = {
		...
		bind: function(t, e) {
			...
			switch (t) {
				case "parsleyForm":
					i = h.extend(new v(this.element, this.domOptions, this.options), new r, window.ParsleyExtend)._bindFields();
					break;
				case "parsleyField":
					i = h.extend(new b(this.element, this.domOptions, this.options, this.parent), new r, window.ParsleyExtend);
					break;
				case "parsleyFieldMultiple":
					i = h.extend(new b(this.element, this.domOptions, this.options, this.parent), new F, new r, window.ParsleyExtend)._init();
					break;
				default:
	...
	var A = h.fn.jquery.split(".");
	if (parseInt(A[0]) <= 1 && parseInt(A[1]) < 8) throw "The loaded version of jQuery is too old. Please upgrade to 1.8.x or better.";
	A.forEach || d.warn("Parsley requires ES5 to run properly. Please include https://github.com/es-shims/es5-shim");
	var E = l(new r, {
		element: document,
		$element: h(document),
	...
	l(b.prototype, g.Field, r.prototype), l(v.prototype, g.Form, r.prototype), l(C.prototype, r.prototype), h.fn.parsley = h.fn.psly = function(t) {
		if (1 < this.length) {
			var e = [];
	...
	}, void 0 === window.ParsleyExtend && (window.ParsleyExtend = {}), E.options = l(d.objectCreate(s), window.ParsleyConfig), window.ParsleyConfig = E.options, window.Parsley = window.psly = E, E.Utils = d, window.ParsleyUtils = {}, h.each(d, function(t, e) {
	...
	var x = window.Parsley._validatorRegistry = new o(window.ParsleyConfig.validators, window.ParsleyConfig.i18n);
	...
	return h.listen = function(t, e) {
		var i;
		if ($(), "object" === n(arguments[1]) && "function" == typeof arguments[2] && (i = arguments[1], e = arguments[2]), "function" != typeof e) throw new Error("Wrong parameters");
		window.Parsley.on(T(t), P(e, i))
		...
		$(), window.Parsley.off(T(e)), h("form,input,textarea,select").each(function() {
			var t = h(this).data("Parsley");
			t && t.off(T(e))
		})
	}, h.emit = function(t, e) {
		$();
		var i = e instanceof b || e instanceof v,
			r = Array.prototype.slice.call(arguments, i ? 2 : 1);
		r.unshift(T(t)), i || (e = window.Parsley), e.trigger.apply(e, u(r))
	}, h.extend(!0, E, {
		asyncValidators: {
			default: {
				fn: function(t) {
		...
		validateString: function(t, e, i, r) {
			...
			if (void 0 === E.asyncValidators[o]) throw new Error("Calling an undefined async validator: `" + o + "`"); - 1 < (e = E.asyncValidators[o].url || e).indexOf("{value}") ? e = e.replace("{value}", encodeURIComponent(t)) : a[r.element.getAttribute("name") || r.element.getAttribute("id")] = t;
			var l = h.extend(!0, i.options || {}, E.asyncValidators[o].options);

			function u() {
				var t = E.asyncValidators[o].fn.call(r, d, e, i);
			...
			n = h.extend(!0, {}, {
				...
				data: a,
				type: "GET"
			}, l), r.trigger("field:ajaxoptions", r, n), s = h.param(n), void 0 === E._remoteCache && (E._remoteCache = {});
			var d = E._remoteCache[s] = E._remoteCache[s] || h.ajax(n);
			return d.then(u, u)
		},
		priority: -1
		...
		return d.warnOnce("Accessing the method `addAsyncValidator` through an instance is deprecated. Simply call `Parsley.addAsyncValidator(...)`"), E.addAsyncValidator.apply(E, arguments)
	}, E.addMessages("en", {
