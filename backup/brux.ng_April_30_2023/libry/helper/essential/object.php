<?php
//*** ObjectX » Tydi™ ~ AO™ • @iamodao • www.osawere.com ~ © 2023 • Apache License ***//
class ObjectX {
	...
	public static function isKeyEmpty($obj, $key) {
		if (self::isKey($obj, $key) && Vars::isEmpty($obj->$key)) {
			return true;
		}
		return false;
	}
	...
	public static function isKeyNotEmpty($obj, $key) {
		if (self::isKey($obj, $key) && Vars::isNotEmpty($obj->$key)) {
			return true;
		}
		return false;
	}
