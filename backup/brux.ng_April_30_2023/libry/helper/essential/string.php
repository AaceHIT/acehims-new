<?php
//*** StringX » Tydi™ ~ AO™ • @iamodao • www.osawere.com ~ © 2023 • Apache License ***//
class StringX {
	...
	public static function isEmpty(&$var) {
		return Vars::isEmpty($var, 'string');
	}
	...
	public static function isNotEmpty(&$var) {
		return Vars::isNotEmpty($var, 'string');
	}
	...
	public static function blur($string, $library, $blur = '***', $strictCase = false) {
		if (self::isNotEmpty($string) && Vars::isNotEmpty($library)) {
