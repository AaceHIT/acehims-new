<?php
//*** ParamQ » Tydi™ ~ AO™ • @iamodao • www.osawere.com ~ © 2023 • Apache License ***//
...
class ParamQ {
	...
	public static function isFound(array $data, $param, $requireOne = false) {
		...
		} elseif (Vars::isNotEmptyArray($param)) {
			if ($requireOne === true) {
